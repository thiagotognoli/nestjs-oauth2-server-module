...
let AccessTokenRepository = class AccessTokenRepository {
    ...
    create(accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.repository.save(accessToken);
        });
    }
    delete(accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.repository.delete(accessToken.id);
        });
    }
    deleteById(id) {
        return __awaiter(this, void 0, void 0, function* () {
...
AccessTokenRepository = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(domain_1.AccessTokenEntity)),
